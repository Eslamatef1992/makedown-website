...
export default function ComingSoon({ title }) {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-linen-50 px-6 text-center">
      ...
      <p className="max-w-sm text-espresso-500">This page is on the roadmap and not built yet.</p>
      <Link to="/" className="font-semibold text-carissma-600 hover:underline">Back to home</Link>
    </div>
  );
}
